...
try:
	prox= requests.get('https://github.com/KAMRUL-506/kamrul/blob/main/proxies.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/KAMRUL-506/kamrul/blob/main/proxies.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/KAMRUL-506/kamrul/blob/main/proxies.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
\033[1;36m║WHATSAPP  : 01603723934           ║║     \x1b[1;91m()/|___|\()\033[1;32m      ║
\033[1;37m║══════════════════════════════════║║        \x1b[1;91m|_|_|\033[1;32m         ║
\033[1;38m║GITHUB    : KAMRUL-506           ║║       \x1b[1;91m|_| |_|\033[1;32m        ║
\033[1;39m║══════════════════════════════════║║                      ║
